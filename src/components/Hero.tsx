    ...
    <section id="accueil" className="hero-gradient min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8 animate-slide-down">
            <div className="relative inline-block">
              <img 
                ...
                alt="Digi.Résonance" 
                className="h-28 w-28 mx-auto mb-6 rounded-full border-4 border-white shadow-2xl animate-pulse-glow"
              />
              <Sparkles className="absolute -top-2 -right-2 text-yellow-400 animate-rotate-360" size={24} />
            </div>
          </div>
          ...
          {/* Subtitle */}
          <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-3xl mx-auto animate-slide-left font-medium">
          ...
          {/* Mission statement */}
          <div className="bg-white/80 backdrop-blur-sm border-2 border-gold-400 rounded-xl p-6 mb-8 max-w-2xl mx-auto animate-slide-right shadow-xl">
            <div className="flex items-center justify-center space-x-3">
              ...
              <Zap className="text-gold-600 animate-bounce" size={24} style={{ animationDelay: '0.5s' }} />
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 animate-slide-up">
            <Button 
              size="lg" 
              className="bg-gold-gradient text-black font-bold text-lg px-8 py-4 hover:shadow-2xl hover:scale-110 transition-all duration-300 border-2 border-gold-600 animate-pulse-glow"
            >
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="border-2 border-orange-500 text-orange-700 hover:bg-orange-500 hover:text-white text-lg px-8 py-4 transition-all duration-300 font-bold hover:scale-105 bg-white/90"
            >
              Demande de devis
            </Button>
          </div>
          ...
          <div className="animate-bounce">
            <ArrowDown className="text-gold-600 mx-auto animate-float" size={28} />
            <p className="text-gray-600 text-sm mt-2 font-semibold">Découvrez nos services</p>
          </div>
        </div>
      </div>
    </section>
